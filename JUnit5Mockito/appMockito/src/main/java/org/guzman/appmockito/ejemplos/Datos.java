package org.guzman.appmockito.ejemplos;
...
public class Datos {
    ...
    public final static List<Examen> EXAMENES_ID_NEGATIVOS= Arrays.asList(new Examen(-5L,"Matemáticas"),new Examen(-6L,"Lenguaje"),
            new Examen(null,"Historia"));
